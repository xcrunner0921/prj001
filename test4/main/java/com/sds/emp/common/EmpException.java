...
/**
 * This EmpException class contains various constructor
...
public class EmpException extends BaseException {
     ...
     *        exception
     */
    public EmpException(final MessageSource messageSource,
     ...
     *        exception
     */
    public EmpException(final String message, final Throwable exception) {
     ...
     *        the message of this exception
     */
    public EmpException(final String message) {
        super(message);
    }
}
