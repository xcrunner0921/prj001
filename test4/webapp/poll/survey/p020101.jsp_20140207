...
function surveyPopup(num, str, NextQ, realCheck){
            ...
            <div class="article">
                ...
                <table class="tbl_list" summary="">
                    ...
                    <tr>
                        ...
                        <td class="txtLeft"><a href="javascript:surveyPopup('<%= surveyWeb.getPollIdx()%>', '<%= surveyWeb.getProgYn()%>', '<%= surveyWeb.getNextQuestNo()%>', '<%= real_check_falg %>');" ><%= surveyWeb.getPollTitle()%></a></td>
