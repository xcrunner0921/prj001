...
<div class="popup_wrap type<%= popup_bgImg %>">
    ...
    <div class="popup_content">
        ...
        %>
        	<% if((questTitle.getPosition_1()).equals("U")){  %>
				<div>
					<img src="<%= questTitle.getFilePath2_1() %><%= questTitle.getSavFname2_1() %>" alt="<%= questTitle.getOrgFname2_1() %>" />
				</div>
			<% }else if(Integer.toString(positionArry.length).equals("2")){  %>
				<div>
		...
		<% } %>
            ...
            <% if(!"".equals(questTitle.getPosition())){ %>
	        	<% if((questTitle.getPosition_1()).equals("D")){ %>
					<div>
						<img src="<%= questTitle.getFilePath2_1() %><%= questTitle.getSavFname2_1() %>" alt="<%= questTitle.getOrgFname2_1() %>" />
					</div>
				<% } %>
