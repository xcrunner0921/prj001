        ...
        <div id="content" class="content">
            ...
            <div class="article">
                <p class="txt_joinPanel">
                    <em class="emph">온라인 패널이란 서울시에서 진행하는 온라인 여론조사에 참여 의사를 밝힌 회원을 말합니다.</em><br />
                    서울시에서는 시민 여러분의 목소리에 귀 기울이는 열린 행정을 구현하고자 교통,환경,문화,주택,복지 등 시정 전반에 대해 면접,전화,
                    인터넷,심청인터뷰 등 다양한 방법으로 여론조사를 실시하고 있습니다.<br /><br />

                    서울시에서 진행하는 온라인 여론조사에 참여하실 시민들을 온라인 패널로 모집합니다.<br />
                    온라인 패널의 의견이나 정보를 여론조사의 분석목적을 위해서만 사용하며, 개인적인 의견이나 신상정보를 누출하지 않으며 통계적
                    자료로만 사용합니다.
                </p>
                <span class="wrap_btnJoin">
                    <a href="<%if (userid.equals("")) {out.print("http://www.seoul.go.kr/seoul/jsp/member/UserLogin.jsp?SITE_GB=GB011&amp;refresh_url=http://research.seoul.go.kr/poll/panel/p010101.jsp");}else{out.print("/poll/mypage/p040101.jsp");} %>"><img src="/img/poll/btn_joinPanel.gif" alt="패널가입하기" /></a>
                ...
                <h3>온라인 패널 혜택</h3>
                <p>
                    온라인 패널 가입 후 온라인 여론조사에 참여하면 소정의 마일리지가 지급됩니다.<br />
