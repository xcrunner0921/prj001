...
<%
	...
	//faq
	String isrc = "http://spp.seoul.go.kr/silguk/research/research_faq.jsp";
%>
...
<div id="wrap">
    ...
    <div id="container" class="faq">
        ...
        <div id="content" class="content">
            <div class="spot">
                <h2><img src="/img/poll/tit_faq.gif" alt="자주하는 질문" /></h2>
            </div>
            <div class="article">
				<iframe title="자주하는 질문" width="710" height="440" src="<%=isrc%>" frameborder="0"></iframe>
            </div>
        </div>
        <!-- //content -->
    </div>
