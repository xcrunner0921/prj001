    ...
    <div id="container" class="index">
        <div class="wrap_colLeft">
            ...
            <div class="postList surveyResult">
				...
				%>
		                    <li>
							<!--<a href="/listSurveyResult.do"><%=(titleLength> 20 ? surveyResult.getPollTitle().substring(0,20)+"..." : surveyResult.getPollTitle()) %></a> -->
							<%if ("LL101".equals(surveyResult.getPollGubun())){ %> 
								<a href="javascript:checkAgent('<%= surveyResult.getPollIdx() %>', '<%= surveyResult.getPollHit() %>');">
							<%}else{ %>
								<a href="javascript:openResult('<%= surveyResult.getPollIdx() %>', '<%= surveyResult.getPollHit() %>');">
							<%} %>
							<%=(titleLength> 20 ? surveyResult.getPollTitle().substring(0,20)+"..." : surveyResult.getPollTitle()) %>
							</a>
							<span><%=surveyResult.getRegDate() %></span></li>
				<%	
					}	
				%>						 
					</ul>                
