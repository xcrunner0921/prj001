    ...
    <div id="container" class="index">
        <div class="wrap_colLeft">
            ...
            <div class="postList notice">
                ...
                <ul>
                <iframe name="board" src="http://www.seoul.go.kr/tongboard/silguk/research/B1612_MainList_626.html" width="320px" height="80" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                </ul>
