	...
	<table cellpadding="0" cellspacing="0" summary="지난투표결과 내용입니다." border="1" >
		...
		<thead>
			...
			<tr>
				...
				<%
					String pollTitle = mobileResultTitle.getPollTitle();
					pollTitle = pollTitle.replaceAll("&", "&amp;");
				%>
				<td><span style="font-weight:bold;"><%= pollTitle %></span></td>
			</tr>
			<tr>
				<th scope="row">내용</th>
				<%
					String pollContents = mobileResultTitle.getPollContents();
					pollContents = pollContents.replaceAll("&", "&amp;");
				%>
				<td><em><%= pollContents %></em></td>
			</tr>
			<tr>
