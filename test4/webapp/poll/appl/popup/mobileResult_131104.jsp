...
<form id="frm" name="frm" method="post" >
	<table cellpadding="0" cellspacing="0" summary="지난투표결과 내용입니다." border="1" >
		...
		<tr>
			...
			int CntHH101,TotalHH101,Avge,AvgeGraph;
			int Cnt,Total,Avge2,Avge2Graph;
			...
			%>
				...
				<h4><%= mobileResult.getQuestNo() %>. <%= mobileResult.getQuestTitle() %>&nbps; (주관식 문제입니다.)</h4>
				<% }else{%>
				<h4><%= mobileResult.getQuestNo() %>. <%= mobileResult.getQuestTitle() %></h4>
				<% } %>
			<%
				}else{
			%> 
