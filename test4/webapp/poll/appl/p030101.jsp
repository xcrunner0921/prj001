    ...
    <div id="container" class="surveyResult">
        ...
        <div id="content" class="content">
            <div class="spot">
                ...
                <p><img src="/img/poll/sub_surveyResult.gif" alt="여론조사가 종료되고, 결과 데이터 검증 후 일부 문항 결과가 공개됩니다. 조사결과 세부내용 문의 및 활용관련 사항은 담당부서와 협의하시고, 활용시 출처를 명기하여 주시기 바랍니다. 여론조사 결과 확인을 위해서 보고서 viewer 프로그램을 설치하셔야 합니다(조사제목을 클릭하세요)." /></p>
            </div>
            <div class="article">
                <div class="searchBox">
                    <span id="dateSet">
