...
<%
	...
	String questNo = (String)request.getAttribute("questNo");
...
function fncAddQuestMng(pollQuestStatus) {
	...
	if (branchYn == "Y") {
		...
		if (pollQuestStatus == "Y") {
			alert("마지막 문항은 분기할 수 없습니다.");
			return;
		}
	}
	...
	// if (FormValidation(document.detailForm) != false) {
		...
		document.detailForm.action = "<c:url value='/addQuestMng.do' />";
	    document.detailForm.submit();
	// }
}
			...
			<div id="contents" class="survey">	
				...
				<table class="list_tbl edit">
					...
					<tr>
						...
						<td>
							<input type="text" name="questNo" id="" value="<%= questNo %>" class="ip100" readonly required fieldTitle="문항 번호" />
						</td>
						...
						<td>
							<select name="graphType" id="" required fieldTitle="그래프 유형">
								...
								%>
								<option value="<%= graphCode.getCodeId() %>"><%= graphCode.getCodeName() %></option>
								<%
									}
								%>
							</select>		
					...
					<tr>
						<th>이미지선택</th>
						<td colspan="3">
							<input type="file" name="questAddfileu" id="" class="ip80p" /> <span class="btn light"><a href="javascript:fncReset('U');">취소</a></span>
						</td>
					</tr>
					<tr>
						<th class="letter2"><span class="red">*</span>문항</th>
						<td colspan="3">
							<input type="text" name="questTitle" id="" value="" class="ip100" required fieldTitle="문항" />
						</td>
					</tr>
					<tr>
						<th>이미지선택</th>
						<td colspan="3">
							<input type="file" name="questAddfiled" id="" class="ip80p" /> <span class="btn light"><a href="javascript:fncReset('D');">취소</a></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="questType" id="" onchange="changeQuestType();" required fieldTitle="문항유형">
								...
								%>
								<option value="<%= questCode.getCodeId() %>"><%= questCode.getCodeName() %></option>
								<%
									}
								%>
							</select>					
						...
						<td>
							<select name="examType" id="examType" onchange="changeExamType();" required fieldTitle="보기유형">
								<%
									for (int i = 0; i < examCodeList.size(); i++) {
										Code examCode = (Code)examCodeList.get(i);
								%>
								<option value="<%= examCode.getCodeId() %>"><%= examCode.getCodeName() %></option>
								<%
									}
								%>
							</select>					
					...
					<tr>
						...
						<td>
							<input type="radio" name="filterYn_" id="filterYnY" onclick="clickFilterYn('Y');" /><label for="">예</label>
							<input type="radio" name="filterYn_" id="filterYnN" onclick="clickFilterYn('N');" checked /><label for="">아니오</label>							
						</td>
						<th>스크리닝 답</th>
						<td>
							<input type="text" name="filterAnswer" id="" class="ip100" disabled />
						</td>
					</tr>
					<tr>
						<th>보기병합</th>
						...
						<th>병합항목</th>
						<td class="sec">
							<input type="text" name="mergeTitle" id="" class="ip100" disabled />
							<input type="text" name="mergeTitle2" id="" class="ip100" disabled />
							<input type="text" name="mergeTitle3" id="" class="ip100" disabled />
						</td>
					</tr>
					<tr>
						<th>분기 여부</th>
						<td>
							<input type="radio" name="branchYn_" id="branchYnY" onclick="clickBranchYn('Y');" /><label for="">예</label>
							<input type="radio" name="branchYn_" id="branchYnN" onclick="clickBranchYn('N');" checked /><label for="">아니오</label>							
						</td>
						<th>보기 로테이션</th>
						<td>
							<input type="radio" name="examRotateyn_" id="" onclick="clickExamRotateyn('Y');" checked /><label for="">예</label>
							<input type="radio" name="examRotateyn_" id="" onclick="clickExamRotateyn('N');" /><label for="">아니오</label>							
						</td>
					</tr>
...
<!--								<input type="text" name="examNo" id="" class="ip80" value="1" readonly />-->
				...
				<div class="btnareaC">
					<span class="btn radiusB"><a href="javascript:fncAddQuestMng('N');">저장 후 계속</a></span>
					<span class="btn radiusB"><a href="javascript:fncAddQuestMng('Y');">저장 후 완료</a></span>
					<span class="btn radiusB"><a href="javascript:fncListQuestMng();">취소</a></span>
				</div>
...
<input type="hidden" name="etcUseYn11" value="N" />
<input type="hidden" name="etcUseYn21" value="N" />
<input type="hidden" name="etcUseYn41" value="N" />
<input type="hidden" name="etcUseYn12" value="N" />
<input type="hidden" name="etcUseYn22" value="N" />
<input type="hidden" name="etcUseYn42" value="N" />
