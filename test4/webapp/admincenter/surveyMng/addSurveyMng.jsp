...
<!--								<option value="">선택</option>-->
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="pollTermstartYmd" id="pollTermstartYmd" title="시작년월일" class="ip80" value="<%= today %>" readonly required fieldTitle="시작년월일" />
<!--							<a href=""><img src="../../img/adminCenter/icon_month.gif" alt="등록일 달력"/></a>-->&nbsp;
							...
							~ 
							<input type="text" name="pollTermendYmd" id="pollTermendYmd" title="종료년월일" class="ip80" value="<%= today %>" readonly required fieldTitle="종료년월일" />
<!--							<a href=""><img src="../../img/adminCenter/icon_month.gif" alt="등록일 달력"/></a>-->&nbsp;
...
<!--							</div>-->
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="pollRestrictYmd" id="pollRestrictYmd" title="최초가입일 제한기준" class="ip80" value="" />
						</td>
					</tr>
				</table><!-- .srch_tbl -->
