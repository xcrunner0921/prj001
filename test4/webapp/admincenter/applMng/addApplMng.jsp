...
function fncAddApplMng() {
	...
	if (document.detailForm.pollBudget.value == "")
		document.detailForm.pollBudget.value = 0;
...
<input type="hidden" name="pollSubject" value="MM001" />
<input type="hidden" name="pollBgimg" value="A" />
<!-- end of list -->
