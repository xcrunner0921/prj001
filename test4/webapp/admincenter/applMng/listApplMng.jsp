		...
		<div class="inner_wrap">
			...
			<div id="contents" class="survey">	
				...
				<table class="srch_tbl">
					<tr>
						<th width="70px;">조사시작일</th>
						<td>
							<input type="text" name="searchRegDatestart" id="searchRegDatestart" title="등록일" class="ip80" value="<%= regDatestart %>" maxlength="10"/>
<!--							<a href=""><img src="../../img/adminCenter/icon_month.gif" alt="등록일 달력"/></a>-->
							~ 
							<input type="text" name="searchRegDateend" id="searchRegDateend" title="등록일 뒷자리" class="ip80" value="<%= regDateend %>" maxlength="10" />
<!--							<a href=""><img src="../../img/adminCenter/icon_month.gif" alt="등록일 달력"/></a>-->
						</td>
...
<!--							<th>비교</th>-->
					...
					<tbody>
						...
						<tr>
							...
							<td><%= nf.format(pollMng.getPanelCnt()) %></td>
