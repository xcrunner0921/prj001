...
<%
	String pollIdx = (String)request.getParameter("pollIdx");
%>
...
<head>
    ...
    <script type = "text/javascript">
        function ZTInstallEndCommand_ZTransferX(param1,param2) {
            ...
            Insert_OZViewer_Param("connection.reportname","/admincenter/admin_answer.ozr");
            Insert_OZViewer_Param("viewer.isframe", "false");
            Insert_OZViewer_Param("viewer.namespace", "seoul_research\\ozviewer");
            
            Insert_OZViewer_Param("odi.odinames","admin_answer");
            Insert_OZViewer_Param("odi.admin_answer.pcount","1");
            Insert_OZViewer_Param("odi.admin_answer.args1","pollIdx=<%= pollIdx %>");
            Start_OZViewer();
        }
    </script>
</head>
