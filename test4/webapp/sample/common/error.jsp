...
function error(){
	...
	if("${exception.messages.solution}" == "close"){
		window.close();
	}else{
		document.location.href = "${exception.messages.solution}";
	}
}
</script>
<body bgcolor="#ffffff" text="#000000" onload="javascript:error();">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="370" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="5"><img
					src="<c:url value='/sample/images/empty.gif'/>" width="1"
					height="120"></td>
			</tr>
		</table>
		</td>
	...
	<tr>
		<td align="center">
		<table width="375" height="153" border="0" cellpadding="0"
			cellspacing="0" background="<c:url value='/sample/images/fail.jpg'/>">
			<tr>
				<td height="153">
					...
					<tr>
						...
						<c:if test="${exception.messages.solution != null}">
							...
							<br />
									...
									</c:if> <c:if test="${exception.messages.reason  != null}">
							<br />
